...
python dashboard_app.py                            # dev server on 0.0.0.0:8080 (config.py DASHBOARD_HOST/PORT); /momentum, /macro, /demand, /triple-screen are read-only sleeve/tracker mirrors; /conviction is read/write (real RBC account)
