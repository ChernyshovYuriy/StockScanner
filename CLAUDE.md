...
python dashboard_app.py                            # dev server on 0.0.0.0:8080 (config.py DASHBOARD_HOST/PORT); /momentum shows the momentum sleeve read-only, /macro shows the macro conviction sleeve read-only, /demand shows demand_signals.db read-only
