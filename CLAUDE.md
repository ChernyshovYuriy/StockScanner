...
python main.py             # end-of-day pipeline (normally runs at 4:30 PM)
python virtual_buy.py      # virtual entry execution (normally runs at 9:30 AM)
python position_monitor.py # position monitoring / virtual exits (normally runs at 3:30 PM)
