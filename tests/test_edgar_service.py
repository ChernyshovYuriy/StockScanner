...
def test_run_collector_flags_today_activist_and_dedups(tmp_path, monkeypatch):
    ...
    # Today's 13D emailed; the older one and the market-wide Form 4 (no watchlist) excluded.
    ...
    # All non-error hits were stored (raw market-wide log), and today is marked sent.
